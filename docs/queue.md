...
- [ ] Q2 — Implement scalar models and exhaustive mixture; add independent E0 checks. **Implementation is on `feat/finite-state-oracle`; CI validation is pending.** Done when hand calculations, normalization, and mixture identities pass.
